...
# ex: 斬撃
    execute if score @s General.Mob.Tick matches 65 run function asset:mob/0123.lexiel_v3/tick/common/slash4

# リセット
    execute if score @s General.Mob.Tick matches 68 run function asset:mob/0123.lexiel_v3/tick/skill_reset
