...
# ex: さらに二発
    execute if entity @s[scores={General.Mob.Tick=50}] run function asset:mob/0059.jack_o_lantern/tick/skill/missile/shoot
    execute if entity @s[scores={General.Mob.Tick=52}] run function asset:mob/0059.jack_o_lantern/tick/skill/missile/shoot
