...
# ex: 速く転がす2
    execute if entity @s[tag=1N.Random,scores={General.Mob.Tick=22}] positioned ^-1.5 ^ ^ run function asset:mob/0059.jack_o_lantern/tick/skill/giant_pumpkin2/pos_type/cross/1
    execute if entity @s[tag=!1N.Random,scores={General.Mob.Tick=22}] positioned ^-1.5 ^ ^ run function asset:mob/0059.jack_o_lantern/tick/skill/giant_pumpkin2/pos_type/cross/3
    execute if entity @s[tag=1N.Random2,scores={General.Mob.Tick=22}] positioned ^ ^ ^-1.5 run function asset:mob/0059.jack_o_lantern/tick/skill/giant_pumpkin2/pos_type/cross/2
    execute if entity @s[tag=!1N.Random2,scores={General.Mob.Tick=22}] positioned ^ ^ ^-1.5 run function asset:mob/0059.jack_o_lantern/tick/skill/giant_pumpkin2/pos_type/cross/4
