...
# ex: dmg調整
    ...
    data modify storage asset:mob Field.Damage.Giant.Neutral set value {Beginning:10f,Clash:17f}
    data modify storage asset:mob Field.Damage.Giant.Penalty set value {Beginning:10f,Clash:25f}
    data modify storage asset:mob Field.Damage.Missile set value 10.0f
    data modify storage asset:mob Field.Damage.Rain set value 8.0f
